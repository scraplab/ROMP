...
def parse_args(input_args=None):
    ...
    parser.add_argument('--save_dict_results',action='store_true', default = False,help = 'whether to save the predictions to a dict (.npz)')
    ...
    log_group.add_argument('--model_path',type = str,default = os.path.join(trained_model_dir, 'ROMP_HRNet32_V1.pkl'),help = 'trained model path')
